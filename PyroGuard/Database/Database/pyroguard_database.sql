...
CREATE TABLE "public"."cameras" (
  ...
  "camera_x_axis" float8,
  "camera_y_axis" float8,
...
-- Records of cameras
-- ----------------------------
INSERT INTO "public"."cameras" VALUES (14, 'examplecam', 0, 0, 'f', 6, 3, 'exampleip', NULL, 45);
...
-- Records of events
-- ----------------------------
INSERT INTO "public"."events" VALUES (46, '2024-06-05 18:06:21.080451', 14, 'f', 6, NULL, '2024-06-05');
...
-- ----------------------------
INSERT INTO "public"."extinguishers" VALUES (11, NULL, 'example fire extinguisher', 1, 1, 6, NULL);
...
-- ----------------------------
INSERT INTO "public"."notifications" VALUES (27, 46, 'example notification', 11, 33, NULL);
INSERT INTO "public"."notifications" VALUES (28, 46, 'example notification', 11, 35, NULL);
INSERT INTO "public"."notifications" VALUES (29, 46, 'example notification', 11, 36, NULL);
INSERT INTO "public"."notifications" VALUES (30, 46, 'example notification', 11, 37, NULL);
...
SELECT setval('"public"."cameras_cameraid_seq"', 14, true);
...
SELECT setval('"public"."events_eventid_seq"', 46, true);
...
SELECT setval('"public"."extinguishers_extinguisherid_seq"', 11, true);
...
SELECT setval('"public"."notifications_notificationid_seq"', 30, true);
